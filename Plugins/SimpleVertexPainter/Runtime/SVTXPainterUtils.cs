...
namespace SVTXPainter
{
    ...
    public static class SVTXPainterUtils
    {
        ...
        public static void SetMaterial(GameObject aGO,Shader shader)
        {
            ...
            if (aGO)
            {
              //  MeshFilter curFilter = aGO.GetComponent<MeshFilter>();
                ...
                foreach (var material in curSkinnned.sharedMaterials)
                {
                    if (material.shader.name == "imgRenkoRenderFramework/PainterVertexColor"  || material.shader.name == "imgRenkoURPToonShaderFramework/imgRenkoURPToonShaderFramework(Outline)")
        ...
        // Lerp
        public static Color VTXColorLerp(Color colorA, Color colorB, float value,bool protectOutlineWidth)
        {
            if (value > 1f)
            {
                return colorB;
            ...
            return new Color(colorA.r + (colorB.r - colorA.r) * value,
                ...
                (protectOutlineWidth ? colorA.a : colorA.a + (colorB.a - colorA.a) * value));
        }
