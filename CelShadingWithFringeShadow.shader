Shader "imgRenkoURPToonShaderFramework(CelShadingWithFringeShadow)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        float _RimSmoothness, _RimStrength, _HairShadowDistace, _HeightCorrectMax, _HeightCorrectMin, _ShadowAutoAdjustByLight;
        ...
        Pass
        {
            ...
            half4 frag(v2f i): SV_Target
            {
             ...
             //   float3 rimColor = _RimColor.rgb * rimStrength * _RimStrength;
                return max(float4(diffuse , 1), _IndirectLightMinColor * baseMap.rgba);
